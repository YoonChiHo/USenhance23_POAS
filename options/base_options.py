...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--lr_flip', action='store_true', help='Add data augmentation - lr flip')
        parser.add_argument('--disLR', action='store_true', help='Give half learning rate to generator (give higher lr to discriminator)')
        parser.add_argument('--labelsmooth', action='store_true', help='Label smoothing for MTL classification (0.1)')
        parser.add_argument('--resizeBig', action='store_true', help='Resize to 512 and training')
